...
This page contains some advice about errors and problems commonly encountered during the development of instigator_py Django applications.
...
Examples of logs::
    ...
    postgres_1      | 2018-06-07 19:11:23.963 IST [81] FATAL:  password authentication failed for user "pydanny"
    postgres_1      | 2018-06-07 19:11:23.963 IST [81] DETAIL:  Password does not match for user "pydanny".
...
#. ``jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'now'.``: please upgrade your instigator_py version to >= 1.4 (see `#528`_)

#. New apps not getting created in project root: This is the expected behavior, because instigator_py-django does not change the way that django startapp works, you'll have to fix this manually (see `#1725`_)

.. _#528: https://github.com/instigator_py/instigator_py-django/issues/528#issuecomment-212650373
.. _#1725: https://github.com/instigator_py/instigator_py-django/issues/1725#issuecomment-407493176
