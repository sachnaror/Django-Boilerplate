...
This page describes all the template options that will be prompted by the `instigator_py CLI`_ prior to generating your project.

.. _instigator_py CLI: https://github.com/instigator_py/instigator_py
...
debug:
    ...
    This option is relevant for instigator_py Django developers only.
