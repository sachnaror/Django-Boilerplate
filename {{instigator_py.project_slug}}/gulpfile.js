...
// Watch
function watchPaths() {
  watch(`${paths.sass}/*.scss`{% if instigator_py.windows == 'y' %}, { usePolling: true }{% endif %}, styles);
  watch(`${paths.templates}/**/*.html`{% if instigator_py.windows == 'y' %}, { usePolling: true }{% endif %}).on('change', reload);
  watch([`${paths.js}/*.js`, `!${paths.js}/*.min.js`]{% if instigator_py.windows == 'y' %}, { usePolling: true }{% endif %}, scripts).on(
    'change',
    reload,
  );
}
