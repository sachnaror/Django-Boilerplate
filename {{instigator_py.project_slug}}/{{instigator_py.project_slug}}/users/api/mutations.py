...
from {{ instigator_py.project_slug }}.users.api.inputs import *
from {{ instigator_py.project_slug }}.users.api.schema import UserObjectType
{%- if instigator_py.use_celery == 'y' %}
from {{ instigator_py.project_slug }}.users.tasks import *
{%- endif %}
{%- if instigator_py.use_celery == 'n' %}
