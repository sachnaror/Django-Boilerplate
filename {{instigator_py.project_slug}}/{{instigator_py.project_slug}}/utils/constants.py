...
timezones_file_path = os.path.join(settings.BASE_DIR, '{{ instigator_py.project_slug }}', 'assets', 'timezones.json')
...
currencies_file_path = os.path.join(settings.BASE_DIR, '{{ instigator_py.project_slug }}', 'assets', 'countries.json')
