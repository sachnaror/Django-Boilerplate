...
from {{ instigator_py.project_slug }}.models import BaseModel
from {{ instigator_py.project_slug }}.utils.constants import DATE_FORMAT_CHOICES, CURRENCY_CHOICES, TIMEZONES, TIME_FORMAT_CHOICES
